...
export default function Slidebar() {
  ...
  return (
    <>
      <div className="flex-none bg-black h-screen min-w-[25%] fixed ld:block lg:block hidden">
        ...
        >
          ...
          <div
            onClick={() =>
              window.open("https://www.instagram.com/quandicode/", "_blank")
            }
          >
            {" "}
          ...
          <div
            onClick={() =>
              window.open("https://www.facebook.com/Vquan2509/", "_blank")
            }
          >
