...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-6 lg:ml-8 w-full">
        <div className="flex flex-col justify-center mt-14 lg:w-full w-fit gap-6">
